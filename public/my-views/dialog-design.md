...
-   **On Open**: Focus should move *into* the dialog.
...
### Backdrop Click
-   **For Info/Alert Dialogs**: Clicking the backdrop *should* close the dialog.
-   **For Form/Input Dialogs**: Clicking the backdrop *should NOT* close the dialog to prevent accidental data loss.
