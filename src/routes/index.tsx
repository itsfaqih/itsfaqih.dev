      ...
      <section className="@container max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="text-lg @xl:text-xl @3xl:text-3xl pt-4 @xl:pt-6 @3xl:pt-10 pb-8 flex flex-col gap-4 leading-relaxed text-pretty">
          ...
          <p>
            ...
            <ExternalLink href="https://schemata.ruine.app">Schemata</ExternalLink>, a drag-and-drop
            ERD builder for visual database schema design.
          </p>
          <p>
            Led cross-functional product teams of 10 engineers and designers. Recognized as top
            performer at <ExternalLink href="https://jatismobile.com/">Jatis Mobile</ExternalLink>{" "}
            (Q4 2022). Contributed to the Indonesian PHP community through <ExternalLink href="https://www.figma.com/design/qNIg0A9h7PnrFdOVSBbMEH/PHPID-Online-Learning-Redesign?node-id=0-1&t=PcPvOnrKzLginYqa-1">UI design work</ExternalLink> for{" "}
...
function PopupContent({ href }: { href: string }) {
