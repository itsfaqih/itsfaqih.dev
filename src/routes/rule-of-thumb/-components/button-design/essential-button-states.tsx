...
{/* States Overview Grid */}
      <div className={cx("rule-of-thumb-feature-grid-section mb-20")}>
        ...
        <ul
          className={cx("rule-of-thumb-feature-grid grid grid-cols-2 md:grid-cols-3 gap-0 pl-px pt-px")}
